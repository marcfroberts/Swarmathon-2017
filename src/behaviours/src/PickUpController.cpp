...
void PickUpController::ProcessData() {
  ...
  if ( (blockDistance*blockDistance - 0.195*0.195) > 0 )//might change
  {
    blockDistance = sqrt(blockDistance*blockDistance - 0.195*0.195);//might change
  }
  else
  {
